...
import { activeState } from '../../store/initalState';
...
const ControState = () => {
    ...
    return (
        <div className='control-container'>
            <div
                className='control-button control-button_runtime'
                id={activeState.runtime}
                onClick={(e) => clickol(e.currentTarget.id)}
            >
            ...
            <div
                className='control-button control-button_constructor contorl-button__active'
                id={activeState.constructor}
            >
